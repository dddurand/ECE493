...
public class DatabaseInterface {
	...
	private final String GAME_ACTION_TABLE = "game_actions";
	 ...
	 * @throws DatabaseInterfaceException
	 */
	public void updateUsersDeltaMoney(Account account, int deltaMoney) throws DatabaseInterfaceException
	{
	 ...
	 * @throws DatabaseInterfaceException
	 */
	public int getMoneyGenerated(Account account) throws DatabaseInterfaceException
	{
		String sql = "SELECT sum(value) from misc_data WHERE accountID = ? and name = ?;";
	 ...
	 * @throws DatabaseInterfaceException
	 */
	public int getGamesPlayed(Account account) throws DatabaseInterfaceException
	{
	 ...
	 * @throws DatabaseInterfaceException
	 */
	public int getGameActionsCount(PokerAction action, Account account) throws DatabaseInterfaceException
	{
	...
	public int getGameActionsTypedNum(Account account, NumerableActionOperation op,
									NumerableActionColumn column, PokerAction action, boolean ignoreZeroValues) throws DatabaseInterfaceException
	{
		String typeLimit = "";
		String ignoreZero = "";
		...
		String sql = "SELECT "+op.getValue()+"("+column.getValue()+") from " + GAME_ACTION_TABLE +
					 " WHERE "+typeLimit+" accountID = ? "+ignoreZero+";";
