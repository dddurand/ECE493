...
CREATE TABLE `user_table` (
  ...
  `delta_money_ALL` int(11) DEFAULT '0',
  `delta_money_DAY` int(11) DEFAULT '0',
  `delta_money_WEEK` int(11) DEFAULT '0',
  `delta_money_MONTH` int(11) DEFAULT '0',
  `delta_money_YEAR` int(11) DEFAULT '0',
