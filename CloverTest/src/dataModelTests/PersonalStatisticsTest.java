...
public class PersonalStatisticsTest extends AndroidTestCase {
	...
	public void testValid()
	{
		...
		PersonalStatistics stats = new PersonalStatistics(obj, context);
	...
	public void testInvalid()
	{
		...
		try {
			obj.put("personal_statistics", invalid);
	...
	private JSONObject getJSON()
	{
		...
		try {
			objwrapper.put("personal_statistics", obj);
		} catch (JSONException e) {
			fail();
		}
	...
	public void setUp()
	{
		...
		values.put("gamesPlayed", 30.1);
		values.put("netMoney", 30.2);
		values.put("avgBet", 30.3);
		values.put("netMoneyRanking", 31.0);
		values.put("optimalityRanking", 32.0);
		values.put("optimality", 33.0);
	}
	...
	public void testRequestSetTimeFrame()
	{
		...
		PersonalStatisticRequest request = new PersonalStatisticRequest(TimeFrame.ALL, account);
